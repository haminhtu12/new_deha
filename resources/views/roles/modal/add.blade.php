    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('users.error')
                <div class="col-md-12">
                    <form class="form-horizontal" data-action="{{route('roles.store')}}" method="post"
                          id="add_role_form" enctype="multipart/form-data">
                        @csrf
                        <fieldset>
                                        ...
                                        <div class="card-header text-white" style="background-color: blue;">
                                            ...
                                            <label>
                                                <input type="checkbox" name="permission_id[]"
                                                       value="{{$permissionsParentItem->id}}" class="checkbox_wrapper"
                                                       data-class="{{($permissionsParentItem->slug_name)}}">
                                            </label>
                                                    ...
                                                    <h5 class="card-title">
                                                        <label>
                                                            <input type="checkbox" value="{{$permission->id}}"
                                                                   name="permission_id[]"
                                                                   class="{{($permissionsParentItem->slug_name).'-select-item'}}">
                                                        </label>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <button type="button" class="btn btn-danger  raised" id="add-submit-role">Submit <i
