                ...
                <div class="modal-body">
                                ...
                                <div class="card-header text-white" style="background-color: blue;">
                                    ...
                                    <label>
                                        <input type="checkbox" name="permission_id[]"
                                               ...
                                               class="checkbox_wrapper permission"
                                            ...
                                            <h5 class="card-title">
                                                <label>
                                                    <input type="checkbox" value="{{$permission->id}}"
                                                           name="permission_id[]"
                                                           class="{{($permissionsParentItem->slug_name).'-select-item'}} permission"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-4">
                                <button type="button" class="btn btn-danger  raised" id="edit-submit-role">Submit <i
